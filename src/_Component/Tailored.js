...
class Tailored extends React.Component {
  constructor() {
    super();
    this.state = { title1: "Economic Uncertainty in the Autologistics World", paragraph1: "With an uncertain economic climate and ever growing inventory, ports and auto manufacturers need a parking material that keeps cars free of dust and damage at a lost cost.", visibility: false };
  }

  render() {
    const { title1, paragraph1, visibility } = this.state;
    return (
      <div className="Main8">
        <VisibilitySensor
